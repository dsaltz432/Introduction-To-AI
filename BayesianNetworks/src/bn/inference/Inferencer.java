...
public abstract class Inferencer {
	...
	protected static BayesianNetwork getBayesianNetworkFromFile(String testFile) {
		testFile = "src/bn/examples/"+testFile; // uncomment for intellij
	 ...
	 */
	protected static boolean getRandResult(double probability, Random random) {
	 ...
	 */
	protected Assignment shallowCopy(Assignment old) {
